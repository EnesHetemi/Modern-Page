...
public class UserPdfExporter extends AbstractExporter {
	...
	private void writeTableHeader(PdfPTable table) {
		...
		cell.setPhrase(new Phrase("Emri", font));		
		table.addCell(cell);

		cell.setPhrase(new Phrase("Mbiemri", font));		
		table.addCell(cell);		

		cell.setPhrase(new Phrase("Rolet", font));		
		table.addCell(cell);

		cell.setPhrase(new Phrase("Aktivizimi", font));		
		table.addCell(cell);		
	}
